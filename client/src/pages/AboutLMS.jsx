...
const AboutLMS = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 sm:px-6 md:px-8">
      ...
      <p className="text-gray-600 mb-3 text-base sm:text-lg leading-relaxed">
        Our Learning Management System (LMS) provides a modern, flexible
        platform to help students and educators achieve their goals.
      </p>

      <h2 className="text-xl font-semibold text-gray-700 mt-6 sm:text-2xl">
        Key Features:
      </h2>
      <ul className="list-disc pl-5 text-gray-600 space-y-1 mt-2 text-sm sm:text-base">
      ...
      <p className="text-gray-600 mt-6 text-sm sm:text-base">
        Built with ❤️ by Elsafwa Team – We Can and We Will. Led by Mahmod
        Elsherif.
      </p>
    </div>
  );
