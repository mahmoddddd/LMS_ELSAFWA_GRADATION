    ...
    <div className="flex md:flex-row flex-col gap-1 relative items-start justify-between md:px-10 px-2 md:pt-10 text-left">
      <div className="space-y-3 w-full">
        ...
        <div className="flex flex-wrap gap-3 items-center justify-center sm:justify-start">
          <div className="flex items-center gap-3 shadow-card border border-blue-500 p-4 w-full sm:w-60 rounded-md">
            <img src={assets.patients_icon} alt="patients_icon" />
            <div>
              <p className="text-sxl font-medium text-gray-500">
        ...
        <div className="w-full max-w-3xl mx-auto">
          ...
          <div className="overflow-x-auto rounded-md bg-white border border-gray-300 shadow-md">
