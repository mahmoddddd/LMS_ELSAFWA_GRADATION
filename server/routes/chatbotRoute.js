...
const KEYWORDS = {
  course: ["course", "class", "lesson", "subject", "topic", "curriculum", "syllabus", "module"],
  enroll: ["enroll", "enrollment", "register", "sign up", "join", "start course", "begin"],
  progress: ["progress", "completion", "finished", "complete", "track", "status", "percentage", "remaining"],
  technical: ["technical", "problem", "issue", "error", "not working", "broken", "video", "audio", "download"],
  payment: ["payment", "price", "cost", "money", "pay", "billing", "subscription", "free", "discount"],
  certificate: ["certificate", "certification", "diploma", "completion", "proof", "credential"]
};
...
router.get("/health", (req, res) => {
  res.json({
    ...
    openrouter_configured: OPENROUTER_API_KEY && OPENROUTER_API_KEY !== "sk-or-v1-...",
    timestamp: new Date().toISOString()
  });
});
